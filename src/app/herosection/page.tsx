...
const HeroSection = () => {
  ...
  useEffect(() => {
    const handleTyping = () => {
      const current = loopNum % textsToType.length;
      const fullText = textsToType[current];
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-amber-50 px-4 max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button className="bg-transparent border-2 border-amber-300 hover:bg-amber-300/10 text-amber-100 font-semibold py-3 px-8 rounded-full transition duration-300">
            Visit Us
          </button>
        </div>
      ...
      {/* Coffee icon (if needed) can remain or be removed */}
      <div className="absolute top-10 right-28 opacity-80">
        {/* Coffee SVG */}
      </div>
